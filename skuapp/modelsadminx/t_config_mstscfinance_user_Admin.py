...
class t_config_mstscfinance_user_Admin(object):
    ...
    def show_passaword(self,obj):
        return mark_safe('******')
    show_passaword.short_description = u'<p style="color:#428BCA">密码(密文)<p>'

    #list_per_page=2000
    list_display=('id','PlatformName','ShopName','seller','IP','out_ip','UserName','show_passaword','show_user','DepartmentName','CloudName','show_status','login_DP','kvmName','shop_status','clean_status')
    ...
    search_fields=('PlatformName','ShopName','seller','IP','out_ip','UserName','DepartmentName','InstanceId','RegionId','CloudName','shop_status','clean_status')
    list_editable=('PlatformName','ShopName','seller','IP','out_ip','UserName','DepartmentName','InstanceId','RegionId','CloudName','kvmName','shop_status','clean_status')
    
    def get_list_queryset(self):
        request = self.request
        qs = super(t_config_mstscfinance_user_Admin, self).get_list_queryset()
