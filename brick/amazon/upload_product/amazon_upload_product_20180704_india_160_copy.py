...
"""  
 ...
 @site: 
 @software: PyCharm
 @file: amazon_upload_product_20180704_india_160.py
 @time: 2018/7/4 9:53
"""
...
class Server():
    ...
    def get_image_xml(self, images, shop_sku, sellerid, variation):
        ...
        for i in images:
            image_url = 'http://' + '47.254.83.145' + '/' + images[i]
    ...
    def get_images_new(self,db_connect, upload_id):
        ...
        try:
            # 主体图片信息
            sql_main = "SELECT id, prodcut_variation_id, item_sku, productSKU, main_image_url, other_image_url1, other_image_url2, other_image_url3, other_image_url4, other_image_url5, other_image_url6, other_image_url7, other_image_url8, item_package_quantity,ShopSets FROM 	t_templet_amazon_wait_upload_copy a WHERE 	id = %s" % upload_id
