...
class t_store_marketplan_execution_aliexpress(models.Model):
    ...
    exe_sum             =    models.IntegerField(u'总需求数量',default=0,blank = True,null = True)
    run_sum             =    models.IntegerField(u'营销数量',default=0,blank=True, null=True)
    ...
    #sd_time_man         =    models.CharField(u'刷单日期/刷单人',max_length=64,blank = True,null = True)
    ...
    class Meta:
        verbose_name=u'Aliexpress营销计划表'
        verbose_name_plural=verbose_name
        db_table = 't_store_marketplan_execution_aliexpress'
        ordering = ['-type_num']
