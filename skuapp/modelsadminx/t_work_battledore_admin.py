...
class t_work_battledore_admin(object):
    ...
    list_display = ('id','show_Image','mainsku','show_needsinfors','show_infors','show_maninfors','show_warning','show_time','show_Link')
    ...
    def get_list_queryset(self,):
        ...
        qs = super(t_work_battledore_admin, self).get_list_queryset()
