...
class t_config_wishapi_product_analyse_info_xprx(models.Model):
    ...
    class Meta:
        verbose_name=u'WISH 新品热销'
        verbose_name_plural=u'WISH 新品热销列表'
        db_table = 't_config_wishapi_product_analyse_info'
        ordering = ['-OrdersLast7Days','-ShelveDay']
