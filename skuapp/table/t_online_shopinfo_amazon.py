...
class t_online_shopinfo_amazon(models.Model):
    ...
    open_date                    =   models.CharField(u'open_date',max_length=64,blank = True,null = True)
    ...
    class Meta:
        verbose_name=u'Amazon商品信息'
        verbose_name_plural=verbose_name
        db_table = 't_online_shopinfo_amazon'
