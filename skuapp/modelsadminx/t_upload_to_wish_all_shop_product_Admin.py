...
class t_upload_to_wish_all_shop_product_Admin(t_online_info_wish_Admin):
    ...
    def get_list_queryset(self):
        ...
        qs = super(t_upload_to_wish_all_shop_product_Admin, self).get_list_queryset()
        t_upload_shopname_objs = t_upload_shopname.objects.all()
        shopname_list = []
        for t_upload_shopname_obj in t_upload_shopname_objs:
            shopname_list.append(t_upload_shopname_obj.ShopName)
        return qs.filter(ShopName__in = shopname_list)