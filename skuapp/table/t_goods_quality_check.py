...
class Newshop_feedback(models.Model):
    ...
    put_name = models.CharField(max_length=60, blank=False, verbose_name=u'提交人')
    ...
    picture = models.ImageField(upload_to='statics/images', verbose_name=u'图片上传1')
    picture1 = models.ImageField(upload_to='statics/images', verbose_name=u'图片上传2')
    picture2= models.ImageField(upload_to='statics/images', verbose_name=u'图片上传3')
...
class GoodsResponse_table(models.Model):
    ...
    # check_name = models.CharField(max_length=60, blank=False, verbose_name='审核人')
    # goodsResponse_result = models.CharField(max_length=60, choices=choice1, verbose_name=u'产品专员反馈审核')
    # check_mean = models.TextField(blank=True, verbose_name=u'备注(审核人意见)')
    # check_time = models.DateTimeField(auto_now_add=True, verbose_name=u'创建时间')
...
class GoodsCheck_table(models.Model):
    ...
    goodsResponse_result = models.CharField(max_length=60, choices=choice1, verbose_name=u'产品专员反馈——审核')
    # bugerResponse_relation = models.ForeignKey(BugerResponse_table, verbose_name=u'采购员反馈信息')
    bugerResponse_result = models.CharField(max_length=60, choices=choice1, verbose_name=u'采购反馈——审核')
    # warehouseSpecialist_relation = models.ForeignKey(WarehouseSpecialist_table, verbose_name=u'仓库反馈信息')
    warehouseSpecialist_result = models.CharField(max_length=60, choices=choice1, verbose_name=u'仓库负责人反馈——审核')
    time = models.DateTimeField(auto_now_add=True, verbose_name=u'创建时间')
    update_time = models.DateTimeField(auto_now=True, verbose_name=u'更新时间')
...
class Result_table(models.Model):
    ...
    sku = models.CharField(max_length=60, blank=True, null=True, verbose_name='Sku')
    gooods_check_man=models.CharField(max_length=60,blank=False,default='',verbose_name=u'审核人')
    goodsResponse_result = models.CharField(max_length=60, choices=choice1, default=3,verbose_name=u'产品专员反馈——审核')
    buger_check_man = models.CharField(max_length=60, blank=False,default='', verbose_name=u'审核人')
    bugerResponse_result = models.CharField(max_length=60, choices=choice1,default=3, verbose_name=u'采购反馈——审核')
    warehouse_check_man = models.CharField(max_length=60, blank=False,default='', verbose_name=u'审核人')
    warehouseSpecialist_result = models.CharField(max_length=60, choices=choice1,default=3,verbose_name=u'仓库负责人反馈——审核')
