...
class t_online_shopinfo_joom3(models.Model):
    ...
    Variant_id                   =   models.CharField(u'Variant_id',max_length=64,blank = True,null = True)
    ...
    class Meta:
        verbose_name=u'Joom3在线商品信息'
        verbose_name_plural=verbose_name
        db_table = 't_online_shopinfo_joom3'
