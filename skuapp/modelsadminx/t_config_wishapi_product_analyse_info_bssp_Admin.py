...
class t_config_wishapi_product_analyse_info_bssp_Admin(t_config_wishapi_product_analyse_info_Admin):
    def get_list_queryset(self, ):
        request = self.request
        qs = super(t_config_wishapi_product_analyse_info_bssp_Admin, self).get_list_queryset()
