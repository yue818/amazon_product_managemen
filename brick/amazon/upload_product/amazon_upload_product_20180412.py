...
class Server():
    ...
    def get_images_new(self,db_connect, upload_id):
        ...
        try:
            ...
            # 变体图片信息
            sql_variation = "SELECT 	id, prodcut_variation_id, child_sku, productSKU, main_image_url, other_image_url1, other_image_url2, other_image_url3, other_image_url4, other_image_url5, other_image_url6, other_image_url7, other_image_url8 FROM 	t_templet_amazon_published_variation a WHERE prodcut_variation_id = %s" % \
                            main_image_info[1]
