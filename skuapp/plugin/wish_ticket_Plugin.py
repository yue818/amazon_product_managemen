...
@software: pycharm
@file: wish_ticket_Plugin.py
@time: 2018-06-11 15:49
'''
...
class wish_ticket_Plugin(BaseAdminPlugin):
    wish_ticket = False

    def init_request(self, *args, **kwargs):
        return bool(self.wish_ticket)
    ...
    def block_search_cata_nav(self, context, nodes):
        ...
        buttonlist.sort()
        nodes.append(loader.render_to_string('wish_ticket.html',
