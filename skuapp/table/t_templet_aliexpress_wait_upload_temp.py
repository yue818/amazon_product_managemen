...
"""  
 ...
 @time: 2018-04-23 16:47
 @desc: 
"""

from django.db import models
class t_templet_aliexpress_wait_upload_temp(models.Model):
    ...
    Price                   =   models.CharField(u'零售价', max_length=10, blank=True, null=True)
    ...
    ShopName                =   models.CharField(u'店铺', max_length=64, blank=True, null=True)
    ShopCode                =   models.CharField(u'店铺编码', max_length=64, blank=True, null=True)
    class Meta:
        verbose_name = u'AliExpress已铺货'
        verbose_name_plural = verbose_name
        db_table = 't_templet_aliexpress_wait_upload_temp'
        ordering = ['-UpdateTime']
        app_label = 'skuapp'
