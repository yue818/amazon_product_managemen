...
class t_product_enter_ed_aliexpress(t_base):
    Aliexpress_PL = models.CharField(u'速卖通品类',max_length=255, blank=True, null=True)
    publish_count  = models.IntegerField(u'刊登次数', blank=True, null=True)
    Back_Aliexpress_PL = models.CharField(u'反向速卖通大类', max_length=255, blank=True, null=True)
    ...
    class Meta:
        verbose_name=u'速卖通刊登信息'
        verbose_name_plural=u' 速卖通刊登信息'
