...
from public import *
#各店铺在线信息
class t_online_info_publish_joom(models.Model):
    ...
    Description    =   models.TextField(u'描述',max_length=255,blank = True,null = True)
    ...
    CostPrice      =   models.CharField(u'成本价',max_length=16,blank=True,null=True)
    Weight         =   models.CharField(u'克重',max_length=16,blank=True,null=True)
    SKUStatus      =   models.IntegerField(u'SKU状态',max_length=11,blank = True,null = True) #状态1是不正常的
    ToExcel        =   models.IntegerField(u'处理状态',max_length=11,blank = True,null = True) #状态0是已导出的（已下架）
    
    class Meta:
        verbose_name=u'在线信息'
        verbose_name_plural=u'在线信息'
        db_table = 't_online_info_publish_joom'
        ordering =  ['ShopSKU']
