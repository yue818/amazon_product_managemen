...
"""  
 ...
 @site: 
 @software: PyCharm
 @file: fba_refresh-20181026.py
 @time: 2018/10/26 9:12
"""
...
for key, val in auth_info_all.items():
    ...
    try:
        ...
        if this_hour >= 20:  # 交易记录全量刷新耗CPU，只在夜晚进行
            logging.debug('this hour is：%s， do not perform full finance refresh' % this_hour)
