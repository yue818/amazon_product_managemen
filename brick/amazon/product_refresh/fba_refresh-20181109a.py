...
"""  
 ...
 @site: 
 @software: PyCharm
 @file: fba_refresh-20181109a.py
 @time: 2018/11/9 14:26
"""
...
class ReportPublic:
    ...
    def listing_insert(self, get_report_data):
        # listing 字段数组
        listing_column_list = list()
        if self.auth_info['ShopSite'] == 'JP':
            listing_column_list = ['item_name', 'listing_id', 'seller_sku', 'price', 'quantity', 'open_date', 'product_id_type', 'item_note', 'item_condition', 'zshop_category1', 'expedited_shipping', 'product_id', 'pending_quantity', 'fulfillment_channel', 'merchant_shipping_group', 'status', 'shopname', 'shopsite']
        else:
            pass
