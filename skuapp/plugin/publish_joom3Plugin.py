...
class publish_joom3Plugin(BaseAdminPlugin):
    pp_flag3 = False

    def init_request(self, *args, **kwargs):
        return bool(self.pp_flag3)
    ...
    def block_search_cata_nav(self, context, nodes):
        ...
        countsdict={}
        lm=[]
        oo = t_online_info_wait_publish_joom3.objects.values_list('FL',flat=True)
        ...
        for i in oo:
            ...
            if i in lm:
                ...
                if i is not None and i != '':
                    counts = t_online_info_wait_publish_joom3.objects.filter(FL='%s'%i.encode('utf-8'),ispublished='未刊登').count()
        ...
        nodes.append(loader.render_to_string('publish_joom3.html',{'url':newurl,'flag':flag,'countsdict':countsdict}))
