...
class ReportPublic:
    ...
    def get_last_order_time(self):
        ...
        if max_time_obj is None or len(max_time_obj) == 0 or max_time_obj[0] is None:
            max_update_time = datetime.datetime.now() + datetime.timedelta(days=-20)
        else:
...
class FinancesPublic:
    ...
    def finance_flow(self, begin_time):
        try:
            ...
            refund_report_raw = self.get_finance_report(begin_time=begin_time)
            print 'get data'
