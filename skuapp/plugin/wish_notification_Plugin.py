...
@software: pycharm
@file: wish_notification_Plugin.py
@time: 2018-06-09 13:41
'''
...
class wish_notification_Plugin(BaseAdminPlugin):
    wish_notification = False

    def init_request(self, *args, **kwargs):
        return bool(self.wish_notification)
    ...
    def block_search_cata_nav(self, context, nodes):
        ...
        buttonlist.sort()
        nodes.append(loader.render_to_string('wish_notification.html',
