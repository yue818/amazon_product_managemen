...
"""  
 ...
 @site: 
 @software: PyCharm
 @file: t_template_amazon_advertising_business_daily_report.py
 @time: 2018/8/21 9:51
"""
...
class t_template_amazon_advertising_business_daily_report(models.Model):
    upload_advertising_file     = models.FileField(u'广告CSV文件', blank=True, null=True)
    upload_business_file        = models.FileField(u'业务CSV文件', blank=True, null=True)
    ...
    advertising_business_date   = models.DateField(u'日统计时间', blank=True, null=True)
    ...
    class Meta:
        verbose_name = u'Amazon广告业务日汇总表'
        verbose_name_plural = verbose_name
        db_table = 't_template_amazon_advertising_business_daily_report'
        ordering = ['-id']
        app_label = 'skuapp'
