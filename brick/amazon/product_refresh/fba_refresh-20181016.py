...
"""  
 ...
 @site: 
 @software: PyCharm
 @file: fba_refresh-20181016.py
 @time: 2018/10/16 08:50
"""  
# -*- coding:utf-8 -*-
...
class ReportPublic:
    ...
    def actionable_order_insert(self, get_report_data):
        ...
        for i, value in enumerate(get_report_data):
            ...
            sql_delete = "delete from t_amazon_actionable_order_data where shop_name ='%s' and sku ='%s' and order_id='%s' and order_item_id = '%s' " % (self.auth_info['ShopName'], sku, order_id, order_item_id)
            print sql_delete
            logging.debug(sql_delete)
            cursor.execute(sql_delete)
