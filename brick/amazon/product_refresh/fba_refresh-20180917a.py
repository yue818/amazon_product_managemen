...
"""  
 ...
 @site: 
 @software: PyCharm
 @file: fba_refresh-2080917a.py
 @time: 2018/9/17 17:13
"""
        ...
        if max_update_time < datetime.datetime.now() + datetime.timedelta(days=-30):
            ...
            for i in range(1, 100):
                ...
                if time_30_days_later < datetime.datetime.now():
                    ...
                    last_refund_time.append(datetime.datetime.now().strftime('%Y-%m-%d'))
                    break
        else:
            last_refund_time.append(max_update_time.strftime('%Y-%m-%d'))
            time_this_day_end = datetime.datetime.now() + datetime.timedelta(days=1)
            last_refund_time.append(time_this_day_end.strftime('%Y-%m-%d'))
