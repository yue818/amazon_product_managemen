...
class t_report_sales_daily_byProductID_Admin(object):
    ...
    list_display = (
        'OrderDay', 'ProductID','SalesVolume',)
    list_editable = None
    ...
    def get_list_queryset(self):
        ...
        qs = super(t_report_sales_daily_byProductID_Admin, self).get_list_queryset()
