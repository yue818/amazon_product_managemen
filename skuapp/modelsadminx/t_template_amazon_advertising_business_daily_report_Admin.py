...
"""  
 ...
 @site: 
 @software: PyCharm
 @file: t_template_amazon_advertising_business_daily_report_Admin.py
 @time: 2018/8/21 10:37
"""
#点击率=点击量/曝光量     点击成本=花费/点击量   ACOS=花费/销售额， AT=订单数/已订购商品数量   AS=花费/链接销售额
class t_template_amazon_advertising_business_daily_report_Admin(object):
    site_left_menu_tree_amazon_advertising_flag = True
    amazon_shop_search_flag = True
    amazon_advertising_shop_report_flag = True
    ...
    def del_action(self,obj):
        rt = u'<input type="button" value="删除" onclick="del_ad(\'%s\')">' % obj.id
        return mark_safe(rt)

    del_action.short_description = u'<p style="width:40px;color:#428bca;" align="center">操作</p>'

    list_display = ('shopname', 'advertising_business_date', 'show_advertising_info', 'show_business_info',
                    'AT_amazon', 'AS_amazon', 'action_remark', 'remark', 'del_action')
    ...
    def get_list_queryset(self, ):
        ...
        qs = super(t_template_amazon_advertising_business_daily_report_Admin, self).get_list_queryset()
