...
"""  
 ...
 @site: 
 @software: PyCharm
 @file: t_amazon_refund_status_plugin.py
 @time: 2018/10/24 14:48
"""
from xadmin.views import BaseAdminPlugin
from django.template import loader


class t_amazon_refund_status_plugin(BaseAdminPlugin):
    refund_status_plugin = False

    def init_request(self, *args, **kwargs):
        return bool(self.refund_status_plugin)
