...
class t_config_apiurl_asin_xprx(models.Model):
    ...
    DevelopName    =   models.CharField(u'开发人',max_length=64,blank = True,null = True)
    DevelopTime    =   models.DateTimeField(u'开发时间',blank = True,null = True)
    dealStatus     =   models.CharField(u'是否处理',choices=getChoices(ChoicedealStatus),max_length=32,blank = True,null = False)

    class Meta:
        verbose_name=u'Amazon榜单新品'
