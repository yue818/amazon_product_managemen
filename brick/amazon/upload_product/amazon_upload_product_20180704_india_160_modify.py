...
"""  
 ...
 @site: 
 @software: PyCharm
 @file: amazon_upload_product_20180704_india_160_modify.py
 @time: 2018/7/24 13:24
"""  
# -*- coding:utf-8 -*-
...
class Server():
    ...
    def __init__(self):
        ...
        self.queue_IP = '210.16.103.56'

    def listen_client(self):
        channel = self.connection.channel()
        queue = self.queue_IP + '_' + 'amazon_upload_toy'
        print queue
    ...
    def get_images_new(self,db_connect, upload_id):
        """
        ��t_templet_amazon_wait_upload��ȡ��skuͼƬ��Ϣ
        ��t_templet_amazon_published_variationȡ����skuͼƬ��Ϣ
        ���б�����ֻ�ϴ�����ͼƬ���������ϴ�����ͼƬ
        ����skuͼƬ�ֵ䣬��ʽ����
        ...
        try:
            ...
            image_all_dic = {}
            if variation_image_info:  # �б�����ֻ�ϴ�����ͼƬ
