...
#5) 正在询价 t_product_wait_enquiry
class t_product_wait_enquiry(models.Model):
    ...
    Keywords       =   models.CharField(u'英文标题',max_length=100,blank = True,null = True)
    Keywords2      =   models.CharField(u'中文标题',max_length=100,blank = True,null = True)
    ...
    Name2          =   models.CharField(mark_safe(u'商品名称<br>(中文)'),max_length=32,blank = True,null = True)
    Material       =   models.CharField(u'材质',max_length=16,blank = True,null = True)
    ...
    SpecialSell    =   models.CharField(u'商品信息备注（产品专员）',max_length=255,blank = True,null = True)
    ...
    AuditTime = models.DateField(u'审核时间', blank=True, null=True)
    ...
    class Meta:
        verbose_name=u'已开发待询价'
        verbose_name_plural=u' 步骤05--已开发待询价'
        db_table = 't_product_wait_enquiry'
        ordering =  ['CreateTime']
