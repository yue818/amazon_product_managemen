...
class mymall_upload_product_info_search_plugin(BaseAdminPlugin):
    mymall_upload_product_info_plugin = False

    def init_request(self, *args, **kwargs):
        return bool(self.mymall_upload_product_info_plugin)
    ...
    def block_search_cata_nav(self, context, nodes):
        ...
        #     synurl = '/syndata_by_mymall_api_shopname/?shopname=%s' % flag
        ...
        nodes.append(
            loader.render_to_string(
                'mymall_upload_product_info_search_plugin_template.html',
                {
