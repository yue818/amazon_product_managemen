...
"""  
 ...
 @site: 
 @software: PyCharm
 @file: t_amazon_product_order_pend_cost_Admin.py
 @time: 2018/9/6 14:32
"""  
...
class t_amazon_product_order_pend_cost_Admin(object):
    ...
    def show_sku_detail(self, obj):
        sku_price_detail = '<p id="pend_detail_%s"><font  color="blue">%s</font><p/>' % (obj.id, obj.product_sku)
        sku_price_detail += '''
                   <script>
                       a = screen.width
                       b = screen.height*0.5
                        $("#pend_detail_%s").on("click", function(){
                         layer.open({
                          type: 2,
                          ...
                          maxmin: true,
                          area: [a+'px', b+'px'],
                          content: "/show_sku_pend_detail/?product_sku=%s",
                          btn: ["关闭页面"],
                          });
                      })
                  </script>
    ...
    list_display = ('id', 'show_sku_detail', 'sku_unit_price', 'quantity','total_price', 'refresh_time')
    ...
    def to_excel(self, request, queryset):
        ...
        sheet.write(0, 2, u'Pending商品量')
        sheet.write(0, 3, u'总成本')
        sheet.write(0, 4, u'更新时间')
        ...
        for qs in queryset:
            ...
            excel_content_list = [qs.product_sku, qs.sku_unit_price, qs.quantity, qs.total_price, refresh_time]
            column = 0
    ...
    def get_list_queryset(self, ):
        ...
        qs = super(t_amazon_product_order_pend_cost_Admin, self).get_list_queryset()
