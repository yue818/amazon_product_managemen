...
"""
 ...
 @site:
 @software: PyCharm
 @file: t_cloth_factory_dispatch_spemanmodify.py
 @time: 2018/4/28 8:53
"""
from t_cloth_factory_dispatch_needpurchase import t_cloth_factory_dispatch_needpurchase
#API指令执行计划完成表
class t_cloth_factory_dispatch_spemanmodify(t_cloth_factory_dispatch_needpurchase):
    class Meta:
        verbose_name=u'供应链专员修定派单计划'
