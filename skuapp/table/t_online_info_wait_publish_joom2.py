...
class t_online_info_wait_publish_joom2(models.Model):
    ...
    Status          =   models.CharField(u'状态',max_length=16,blank = True,null = True)
    ...
    MainSKU         =   models.CharField(u'MainSKU',max_length=63,blank = True,null = True)
    FL              =   models.CharField(u'FL',max_length=20,blank = True,null = True)


    class Meta:
        verbose_name=u'Joom2待刊登商品信息'
        verbose_name_plural=verbose_name
        db_table = 't_online_info_wait_publish_joom2'
