...
def Joom_Get_Products_Client(shop_name=None, product_id='', flag=0):
    db_res = run({})
    ...
    joom_ip_shop = dict()
    for i in res:
        queue = str(i['IP']) + '_joom_get_product'
        shop_dict = dict()
    ...
    for i in joom_ip_shop.keys():
        ...
        # if i == '121.43.198.134_joom_get_product':
        # if i == '119.23.144.25_joom_get_product':
        # if i == '120.26.7.212_joom_get_product':
        # if i == '115.29.213.208_joom_get_product':
        # if i in ['120.76.171.177_joom_get_product', '120.76.118.141_joom_get_product', '121.41.52.241_joom_get_product']:
        # if i == 'joom_1_local_ip_joom_get_product':
        # if i == '114.115.161.21_joom_get_product':
        if i:
            # print joom_ip_shop[i]
...
# shop_name = 'JOOM-0002-05-WomenBeauty/YW'
# product_id = '1510382499294749623-242-1-709-3217789742'
# flag = 0
# Joom_Get_Products_Client(shop_name=shop_name, flag=flag)
# UPDATE ALL
# Joom_Get_Products_Client()
