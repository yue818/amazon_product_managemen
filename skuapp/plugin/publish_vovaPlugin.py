...
class publish_vovaPlugin(BaseAdminPlugin):
    vova_flag = False

    def init_request(self, *args, **kwargs):
        return bool(self.vova_flag)
    ...
    def block_search_cata_nav(self, context, nodes):
        ...
        countsdict={}
        lm=[]
        oo = t_online_info_wait_publish_vova.objects.values_list('FL',flat=True)
        ...
        for i in oo:
            ...
            if i in lm:
                ...
                if i is not None and i != '':
                    counts = t_online_info_wait_publish_vova.objects.filter(FL='%s'%i.encode('utf-8'),ispublished='未刊登').count()
        ...
        nodes.append(loader.render_to_string('publish_vova.html',{'url':newurl,'flag':flag,'countsdict':countsdict}))
