...
class t_config_mstsc(models.Model):
    ...
    #RegionId                 =   models.CharField(u'主机所在地区',max_length=20,blank = True,null = True)
    ...
    #CloudName                 =   models.CharField(u'主机平台',max_length=255,blank = True,null = True)
    ...
    class Meta:
        verbose_name=u'远程桌面登录'
        verbose_name_plural=u'远程桌面登录'
