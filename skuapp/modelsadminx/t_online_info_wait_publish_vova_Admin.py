...
class t_online_info_wait_publish_vova_Admin(object):
    downloadxls = True
    import_flag = False
    vova_flag = True
    ...
    def get_list_queryset(self,):
        ...
        qs = super(t_online_info_wait_publish_vova_Admin, self).get_list_queryset()
    ...
    def to_excel(self, request, queryset):
        ...
        sheet.write(0, 1, u'CostPrice')#成本价
        sheet.write(0, 2, u'重量')#重量
        sheet.write(0, 3, u'最小包装数')#最小包装数
        sheet.write(0, 4, u'单位')#单位
        sheet.write(0, 5, u'备注')#备注
        sheet.write(0, 6, u'商品名称')#商品名称
        sheet.write(0, 7, u'Product Unique ID') #Wish店铺主SKU
        sheet.write(0, 8, u'Variation Unique ID') #Wish店铺子SKU
        sheet.write(0, 9, u'Vova Category ID') #类目(空)
        sheet.write(0, 10, u'Parent SKU')#SKU(空)
        sheet.write(0, 11, u'SKU')#空
        sheet.write(0, 12, u'Goods Name')#标题
        sheet.write(0, 13, u'Quantity')#9999
        sheet.write(0, 14, u'Goods Description')#描述
        sheet.write(0, 15, u'Tags(Keywords)')#标签
        sheet.write(0, 16, u'Goods Brand')#空
        sheet.write(0, 17, u'Market Price')#空
        sheet.write(0, 18, u'Shop Price')#描述     
        sheet.write(0, 19, u'Shipping Fee')#空    
        sheet.write(0, 20, u'Shipping Weight')#Weight/1000  
        sheet.write(0, 21, u'Shipping Time')#空  
        sheet.write(0, 22, u'From Platform')#wish  
        sheet.write(0, 23, u'Size')#L  
        sheet.write(0, 24, u'Color')#y颜色  
        sheet.write(0, 25, u'Main Image URL')#主图
        sheet.write(0, 26, u'Extra Image URL')
        sheet.write(0, 27, u'Extra Image URL 1')#附图1
        sheet.write(0, 28, u'Extra Image URL 2')#2
        sheet.write(0, 29, u'Extra Image URL 3')#3
        sheet.write(0, 30, u'Extra Image URL 4')#4
        sheet.write(0, 31, u'Extra Image URL 5')#5
        sheet.write(0, 32, u'Extra Image URL 6')#6
        sheet.write(0, 33, u'Extra Image URL 7')#7
        sheet.write(0, 34, u'Extra Image URL 8')#8
        sheet.write(0, 35, u'Extra Image URL 9')#9
        sheet.write(0, 36, u'Extra Image URL 10')#10
        sheet.write(0, 37, u'Extra Image URL 11')#2
        sheet.write(0, 38, u'Extra Image URL 12')#3
        sheet.write(0, 39, u'Extra Image URL 13')#4
        sheet.write(0, 40, u'Extra Image URL 14')#5
        sheet.write(0, 41, u'Extra Image URL 15')#6
        sheet.write(0, 42, u'Extra Image URL 16')#7
        sheet.write(0, 43, u'Extra Image URL 17')#8
        sheet.write(0, 44, u'Extra Image URL 18')#9
        sheet.write(0, 45, u'Extra Image URL 19')#10
        sheet.write(0, 46, u'Extra Image URL 20')#10
        ...
        for qs in queryset:
            ...
            for t_online_info_obj in info_objs:
                ...
                column = column + 1
                try:
                    PackageCount = py_b_goods.objects.get(SKU=t_online_info_obj['SKU']).PackageCount
                except:
                    PackageCount = ''
                sheet.write(row,column,PackageCount)

                column = column + 1
                sheet.write(row,column,u'个')
                
                column = column + 1
                sheet.write(row,column,u'')
                
                column = column + 1
                try:
                    GoodsName = py_b_goods.objects.get(SKU=t_online_info_obj['SKU']).GoodsName
                except:
                    GoodsName = ''
                sheet.write(row,column,GoodsName)
                ...
                column = column + 1
                sheet.write(row,column,'20')

                column = column + 1
                sheet.write(row,column,'wish')
            ...
            t_online_info_wait_publish_vova.objects.filter(ProductID=qs.ProductID).update(ispublished='已刊登')
