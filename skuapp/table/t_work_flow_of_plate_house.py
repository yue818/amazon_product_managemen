...
"""  
 ...
 @site: 
 @software: PyCharm
 @file: t_work_flow_of_plate_house.py
 @time: 2018/6/12 19:30
"""

from django.db import models

class t_work_flow_of_plate_house(models.Model):
    ...
    shippinginformation  =   models.CharField(u'发货信息', max_length=255,blank = True,null = True)
    ok_time = models.DateTimeField(u'发货完成时间', blank=True, null=True)
    paraphrase_version = models.CharField(u'套用版本', max_length=64,blank = True,null = True)

    class Meta:
        verbose_name=u'转供应链进度跟踪'
        verbose_name_plural=verbose_name
        db_table = 't_work_flow_of_plate_house'
